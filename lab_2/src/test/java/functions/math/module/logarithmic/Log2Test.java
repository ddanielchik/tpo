...
class Log2Test {
    ...
    void shouldReturnNaNForZero() {
        assertTrue(Double.isNaN(log2.calc(0.0)));
    }

    @Test
    void shouldReturnNaNForNegativeValue() {
        assertTrue(Double.isNaN(log2.calc(-1.0)));
    }

    @Test
    void shouldReturnNaNForNaN() {
        assertTrue(Double.isNaN(log2.calc(Double.NaN)));
    }

    @Test
    void shouldReturnNaNForPositiveInfinity() {
        assertTrue(Double.isNaN(log2.calc(Double.POSITIVE_INFINITY)));
    }
}